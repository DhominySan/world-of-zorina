...
public class PlayerInput : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        rightAtkBtn.Tick(Input.GetMouseButton(1), Time.deltaTime); // Right attack with right mouse button
        ...
        jup = mouseY; // Look Up/Down with mouse Y axis
        jright = mouseX; // Look Left/Right with mouse X axis
